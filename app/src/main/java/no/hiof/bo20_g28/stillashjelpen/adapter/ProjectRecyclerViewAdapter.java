...
public class ProjectRecyclerViewAdapter extends RecyclerView.Adapter<ProjectRecyclerViewAdapter.ViewHolder>{
    ...
    private ProjectRecyclerViewAdapter.ItemClickListener mClickListener;

    // data is passed into the constructor
    public ProjectRecyclerViewAdapter(Context context, List<Project> data) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        Project p = mData.get(position);
        holder.projectNameTextView.setText(p.getProjectName());
    }
